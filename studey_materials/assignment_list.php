    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="tmarks" id="tmarks" class="form-control">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                <label for="ssdate">Submission Start Date</label>
                <input type="date" name="ssdate" id="ssdate" class="form-control">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label for="sedate">Submission End Date</label>
                <input type="date" name="sedate" id="sedate" class="form-control">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
